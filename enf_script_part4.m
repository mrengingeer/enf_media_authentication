%Comparison of recording2.wav and ground truth2.wav sound files WITH preprocessing: 
...
load('G.mat');
x = transpose(audioread("recording 2.wav"));        %read audio test file 'Recording.wav'
y = transpose(audioread("ground truth 2.wav"));     %read audio reference file 'Ground Truth.wav'
...
surf(l,m,y1); 
title("Surface Plot for 'Recording2.wav' at 120Hz With Preprocessing"'); 
figure; 
...
title("Surface Plot for 'Ground Truth 2.wav' at 120Hz With Preprocessing"); 
figure;
